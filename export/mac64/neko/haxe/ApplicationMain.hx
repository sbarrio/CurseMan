...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("sbarrio", "CurseMan", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "CurseMan", null, { width: 380, height: 285 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 380, height: 285 });
			#end
